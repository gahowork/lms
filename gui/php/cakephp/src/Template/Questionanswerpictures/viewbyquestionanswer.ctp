	...
	<nav class="panel-heading navbar navbar-default">
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav">
				...
				<li><div><?= $this->Html->link('<span class="glyphicon glyphicon-pencil"></span>', ['action' => 'editbyquestionanswer', $questionanswerpicture->id], ['class'=>'btn btn-warning navbar-btn', 'escape'=>false]) ?></div></li>
			</ul>
	...
	<div class="panel-body">
		<fieldset>
			<div class="form-group">
				<?= $this->Element('Gui/pictureViewForm',['picture'=>$questionanswerpicture->picture]) ?>
			</div>
		</fieldset>
	</div>
</div>
