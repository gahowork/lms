	...
	<nav class="panel-heading navbar navbar-default">
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav">
				...
				<li><div><?= $this->Html->link('<span class="glyphicon glyphicon-pencil"></span>', ['action' => 'edit', $adventurequestion->id], ['class'=>'btn btn-warning navbar-btn', 'escape'=>false]) ?></div></li>
			</ul>
	...
	<div class="panel-body">
		<fieldset>
			...
			<div class="form-group">
				...
				<?= $adventurequestion->has('adventure') ? $this->Html->link('<span class="label">' . $adventurequestion->adventure->description . '</span> <span class="glyphicon glyphicon-zoom-in"></span>', ['controller' => 'Adventures', 'action' => 'view', $adventurequestion->adventure->id], ['class'=>'btn btn-info', 'id'=>'adventurequestionadventure_id', 'escape'=>false]) : '' ?>
			</div>
			<div class="form-group">
