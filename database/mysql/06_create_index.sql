...
CREATE INDEX ix_questionanswerpictures_questionanswer_id ON questionanswerpictures(questionanswer_id ASC);
CREATE INDEX ix_questionanswerpictures_picture_id ON questionanswerpictures(picture_id ASC);
...
CREATE UNIQUE INDEX ux_questionanswers ON questionanswers(question_id ASC, answer ASC, result ASC);
CREATE UNIQUE INDEX ux_questionanswerpictures ON questionanswerpictures(questionanswer_id ASC, picture_id ASC);
